        ...
        >
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="p-6 shadow-xl shadow-gray-400 bg-black border-4  border-blue-500 rounded-xl hover:scale-105 ease-in duration-300">
              <div className="flex flex-col  gap-4 justify-center items-center">
                <div className="m-auto">
                  <Image src={HTML} width="64px" height="64px" alt="/" onLoad={() => setIsLoaded(true)} />
                </div>
            ...
            <div className="p-6 shadow-xl shadow-gray-400 bg-black border-4  border-blue-500 rounded-xl hover:scale-105 ease-in duration-300">
              <div className="flex flex-col  gap-4 justify-center items-center">
                <div className="m-auto">
                  <Image src={JavaScript} width="64px" height="64px" alt="/" onLoad={() => setIsLoaded(true)} />
                </div>
                <div className="flex flex-col  gap-4 justify-center items-center">
            ...
            <div className="p-6 shadow-xl shadow-gray-400 bg-black border-4  border-blue-500 rounded-xl hover:scale-105 ease-in duration-300">
              <div className="flex flex-col  gap-4 justify-center items-center">
                <div className="m-auto">
                  <Image src={NextJS} width="64px" height="64px" alt="/" onLoad={() => setIsLoaded(true)}/>
                </div>
                <div className="flex flex-col  gap-4 justify-center items-center">
            ...
            <div className="p-6 shadow-xl shadow-gray-400 bg-black border-4  border-blue-500 rounded-xl hover:scale-105 ease-in duration-300">
              <div className="flex flex-col  gap-4 justify-center items-center">
                <div className="m-auto">
                  <Image src={nodeLogo} width="64px" height="64px" alt="/" onLoad={() => setIsLoaded(true)} />
                </div>
                <div className="flex flex-col  gap-4 justify-center items-center">
            ...
            <div className="p-6 shadow-xl shadow-gray-400 bg-black border-4  border-blue-500 rounded-xl hover:scale-105 ease-in duration-300">
              <div className="flex flex-col  gap-4 justify-center items-center">
                <div className="m-auto">
                  <Image src={CSS} width="64px" height="64px" alt="/" onLoad={() => setIsLoaded(true)} />
                </div>
                <div className="flex flex-col  gap-4 justify-center items-center">
            ...
            <div className="p-6 shadow-xl shadow-gray-400 bg-black border-4  border-blue-500 rounded-xl hover:scale-105 ease-in duration-300">
              <div className="flex flex-col  gap-4 justify-center items-center">
                <div className="m-auto">
                  <Image src={bootstrap} width="64px" height="64px" alt="/" onLoad={() => setIsLoaded(true)} />
                </div>
                <div className="flex flex-col  gap-4 justify-center items-center">
            ...
            <div className="p-6 shadow-xl shadow-gray-400 bg-black border-4  border-blue-500 rounded-xl hover:scale-105 ease-in duration-300">
              <div className="flex flex-col  gap-4 justify-center items-center">
                <div className="m-auto">
                  <Image src={TailWind} width="64px" height="64px" alt="/" onLoad={() => setIsLoaded(true)} />
                </div>
                <div className="flex flex-col  gap-4 justify-center items-center">
            ...
            <div className="p-6 shadow-xl shadow-gray-400 bg-black border-4  border-blue-500 rounded-xl hover:scale-105 ease-in duration-300">
              <div className="flex flex-col  gap-4 justify-center items-center">
                <div className="m-auto">
                  <Image src={mysql} width="64px" height="64px" alt="/" onLoad={() => setIsLoaded(true)} />
                </div>
                <div className="flex flex-col  gap-4 justify-center items-center">
            ...
            <div className="p-6 shadow-xl shadow-gray-400 bg-black border-4  border-blue-500 rounded-xl hover:scale-105 ease-in duration-300">
              <div className="flex flex-col  gap-4 justify-center items-center">
                <div className="m-auto">
                  <Image src={mongoLogo} width="64px" height="64px" alt="/" onLoad={() => setIsLoaded(true)} />
                </div>
                <div className="flex flex-col  gap-4 justify-center items-center">
