      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <p>
            ...
            their annual plant sale to the next level. For this he first wanted
            to showcase his inventory which is where we brought in Contentful.
            More updates to come.
          </p>
          <button className="px-8 py-2 mt-4 mr-8" onClick={(e) => {
                                e.preventDefault();
                                window.location.href = 'https://drews-plant-nursery.vercel.app/'
                            }} >Website</button>
        </div>
